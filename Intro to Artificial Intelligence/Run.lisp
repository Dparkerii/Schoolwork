(mapcoloring '((AL (GA FL MS TN))             ; AL = Alabama
               (AK ())                        ; AK = Alaska
               ...
               (WY (ID MT SD NE CO UT))) `(RED GRN BLU YLW))
...
(DEFPARAMETER *colors* `(RED GRN BLU YLW))
(coloring  `(MO CO TN ID PA SD MA VA IN TX WI AZ GA NE KY AR NV))
